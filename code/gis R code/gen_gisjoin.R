...
tracts1960 = readOGR(dsn="./raw/nhgis/tract1960 - 2000 TL/", layer="US_tract_1960")
tracts1960.df <- as(tracts1960, "data.frame")

tracts1950 = readOGR(dsn="./raw/nhgis/tract1950 - 2000 TL/", layer="US_tract_1950")
...
write.table(output2010, file="./temp/gisjoin2010.csv", row.names = F)
...
write.table(output1960, file="./temp/gisjoin1960.csv", row.names = F)
...
write.table(output1950, file="./temp/gisjoin1950.csv", row.names = F)
