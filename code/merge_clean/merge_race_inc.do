...
//1980
import delimited "${main}/raw/nhgis/nhgis0004_csv/nhgis0004_ds107_1980_tract.csv", encoding(ISO-8859-1)clear
...
keep gisjoin year state* cnty* county tract smsaa *k 
save "${temp}/clean1980incrace.dta", replace
export delimited "${temp}/clean1980incrace.csv", replace

//1990
import delimited "${main}/raw/nhgis/nhgis0004_csv/nhgis0004_ds123_1990_tract.csv", encoding(ISO-8859-1)clear
...
keep gisjoin year state* cnty* county tract msa_cmsaa *k 
save "${temp}/clean1990incrace.dta", replace
export delimited "${temp}/clean1990incrace.csv", replace

//2000
import delimited "${main}/raw/nhgis/nhgis0004_csv/nhgis0004_ds151_2000_tract.csv", encoding(ISO-8859-1)clear
...
//2010
import delimited "${main}/raw/nhgis/nhgis0004_csv/nhgis0004_ds177_20105_2010_tract.csv", encoding(ISO-8859-1)clear
...
keep gisjoin year state* cnty* county tract cbsaa *k 
